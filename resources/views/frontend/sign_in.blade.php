...
<body>
    ...
    <body>
        <div class="message">
            <i class="fas fa-check-circle"></i> .تم تسجيل بياناتك بنجاج
        </div>
        <section id="hero" class="d-flex align-items-center">
            <div class="container">
                <h1>مرحبا بك في صفحه تسجيل دخول الطبيب</h1>
                <h2>نتمي ان تكون سعيد بتجربتك في الموقع</h2>
                <a href="#login" class="btn-get-started scrollto">تسجيل الدخول</a>
            </div>
        </section>
        ...
        <div class="limiter" id="login">
            <div class="container-login100">
                <div class="wrap-login100">
                    <form class="login100-form validate-form" action="{{ Route('doctor.login') }}" method="POST">
                        @csrf
                        <span class="login100-form-title p-b-26">
                            مرحبا !
                        </span>
                        <span class="login100-form-title p-b-48">
                            <i class="zmdi zmdi-font" title="Doctor"></i>
                        </span>
                        ...
                        <div class="wrap-input100">
                            <input class="input100" type="text" name="email" style="text-align: right">
                        ...
                        <div class="wrap-input100"  data-validate="Enter password">
                            ...
                            <input class="input100" id="password" type="password" name="pass" style="text-align: right">
                        ...
                        <div class="container-login100-form-btn">
                            <div class="wrap-login100-form-btn">
                                ...
                                <button class="login100-form-btn" id="logintext">
                                    دخول
                                </button>
                            </div>
                        </div>
