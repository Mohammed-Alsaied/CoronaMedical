                                        ...
                                        <tbody>
                                            @foreach ($ills as $ill)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><a href="{{ Route('healed.patients',$ill->id) }}" class="btn btn-success btn-sm">تم الشفاء</a></td>
                                                       {{--  <td><a href="{{ Route('delete.contactedpatients',$ill->id) }}" class="btn btn-danger btn-sm">حذف</a></td> --}}
                                                    </tr>
                                                    @endforeach
                                        </tbody>
                                    </table>
